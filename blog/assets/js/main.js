    ...
    document.addEventListener("keydown", function(e) {
      ...
      if (e.keyCode == 38) {//Up Arrow
        ...
        for (var i = 0; i < songName.length; i ++) {
          if (audioMix.src == "https://wangy932.github.io/blog/assets/media/audio/" + songName[i].innerHTML.split(" ").join("%20").split("&amp;").join("&") + ".m4a") {
            if (audioMix.paused) {
              audioPlaySet();
...
function songClick(node) {
  ...
  var newMixSrc = "https://wangy932.github.io/blog/assets/media/audio/" + node.children[0].innerHTML.split(" ").join("%20").split("&amp;").join("&") + ".m4a";
  var newInsSrc = "https://wangy932.github.io/blog/assets/media/audio/" + node.children[0].innerHTML.split(" ").join("%20").split("&amp;").join("&") + "-Instrumental.m4a";
